...
export const businesses: BusinessProfile[] = [
  ...
  },
  {
    ...
    design: {
      ...
      pageAccentGlow: "#f59e0b",
      sidebarBg: "bg-amber-900 text-amber-50",
      sidebarActiveBg: "bg-amber-800",
      sidebarActiveBar: "from-amber-400 to-yellow-300",
      sidebarIconColor: "text-amber-300",
      headingClass: "font-bold text-amber-900",
      badgeBg: "bg-amber-100",
      badgeText: "text-amber-800",
      cardRadius: "rounded-[16px]",
      cardBg: "bg-amber-50/90 backdrop-blur",
      cardBorder: "border-amber-200",
      primary: "#f59e0b",
      primaryMuted: "#f59e0b14",
      kpiVariant: "spark",
      surfaceStyle: "warm",
      density: "balanced",
      navStyle: "pill",
    ...
    palette: {
      ...
      glow: "shadow-[0_24px_90px_-40px_rgba(245,158,11,0.78)]",
      soft: "bg-amber-500/10",
      border: "border-amber-200/70",
      badge: "bg-amber-500/12 text-amber-700",
      chart: ["#f59e0b", "#f97316", "#fb7185"]
    },
    vocabulary: {
      crm: "Торговые точки",
  ...
  },
  {
    ...
    design: {
      ...
      pageBg: "bg-gradient-to-br from-rose-950 via-stone-900 to-orange-950",
      pageAccentGlow: "#f43f5e",
      sidebarBg: "bg-rose-950 text-rose-100",
      sidebarActiveBg: "bg-rose-900",
      sidebarActiveBar: "from-rose-400 to-orange-300",
      sidebarIconColor: "text-rose-300",
      headingClass: "font-semibold text-rose-100",
      badgeBg: "bg-rose-900",
      badgeText: "text-rose-200",
      cardRadius: "rounded-[20px]",
      cardBg: "bg-rose-900/60 backdrop-blur",
      cardBorder: "border-rose-800/50",
      primary: "#f43f5e",
      primaryMuted: "#f43f5e14",
    ...
    palette: {
      ...
      glow: "shadow-[0_24px_90px_-40px_rgba(244,63,94,0.78)]",
      soft: "bg-rose-500/10",
      border: "border-rose-200/70",
      badge: "bg-rose-500/12 text-rose-700",
      chart: ["#f43f5e", "#f97316", "#facc15"]
    },
    vocabulary: {
      crm: "Гости и брони",
      inventory: "Кладовая",
